...
1. Questions
   - Need - There are often tens of golf courses within a manageable driving distance from any given location. Each course has its own website and tee sheet, which makes it time consuming to find an open tee time that works for a user. When finding a time is more important then the specific course, consolidating efforts into a single tee sheet is valuable.
...
| I am going to show you this screen for five seconds. What does this product do? | It looks like it will help me find a tee time faster. |
